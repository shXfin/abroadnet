...
const en: QuizStep[] = [
  ...
  },
  {
    id: "budget",
    kind: "single",
    question: "What's your yearly tuition budget?",
    tip: "Romania often costs less per year than Malaysia, even with the EU degree.",
    options: [
      { value: "under3k", label: "Under $3,000" },
      { value: "3to6k", label: "$3,000 to $6,000" },
      { value: "6to10k", label: "$6,000 to $10,000" },
  ...
  },
  {
    id: "english",
    kind: "single",
    question: "Have you taken an English test?",
    tip: "Some Malaysian programs waive IELTS if your prior medium of instruction was English.",
    options: [
      { value: "ielts", label: "Yes, IELTS" },
      { value: "other_test", label: "Yes, PTE or Duolingo" },
      { value: "planning", label: "Not yet, planning to" },
      { value: "exempt", label: "Not required for my program" },
    ],
  },
  {
    id: "academic",
...
const bn: QuizStep[] = [
  ...
  },
  {
    id: "budget",
    kind: "single",
    question: "বছরে টিউশনের বাজেট কত?",
    tip: "ইইউ ডিগ্রি হওয়া সত্ত্বেও রোমানিয়ার বছরের খরচ প্রায়ই মালয়েশিয়ার চেয়ে কম।",
    options: [
      { value: "under3k", label: "$৩,০০০ এর নিচে" },
      { value: "3to6k", label: "$৩,০০০ থেকে $৬,০০০" },
      { value: "6to10k", label: "$৬,০০০ থেকে $১০,০০০" },
      { value: "above10k", label: "$১০,০০০ এর বেশি" },
  ...
  },
  {
    id: "english",
    kind: "single",
    question: "ইংরেজি টেস্ট দিয়েছেন?",
    tip: "মাধ্যম ইংরেজি ছিল এমন শিক্ষার্থীদের জন্য অনেক মালয়েশিয়ান প্রোগ্রামে IELTS মাফ হয়ে যায়।",
    options: [
      { value: "ielts", label: "হ্যাঁ, IELTS দিয়েছি" },
      { value: "other_test", label: "হ্যাঁ, PTE বা Duolingo দিয়েছি" },
      { value: "planning", label: "না, দেওয়ার পরিকল্পনা আছে" },
      { value: "exempt", label: "আমার প্রোগ্রামে প্রয়োজন নেই" },
    ],
  },
  {
    id: "academic",
